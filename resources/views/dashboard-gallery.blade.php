    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a href="/admin/gallery/create" class="btn btn-primary btn-sm">
                    Tambah Gallery
                </a>
            </div>
            <div class="card-body">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($galleries as $item) 
                            <tr>
                                <th  style="width:5%;" scope="row">{{ $galleries->firstItem() + $loop->index }}</th>
                                <td style="width:30%;">
                                ...
                                <td style="width:10%;">
                                    ...
                                    <form action="/admin/gallery/{{ $item->id }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah anda yakin ingin menghapus kategori ini?');">
                                        @csrf
                                        @method('DELETE')
